...
const LazyMessageList = React.lazy(() => import('./MessageList'));
...
const ChatArea = ({ conversation, currentUser }) => {
    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center px-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-300">Welcome to ChatApp</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-2 max-w-sm">Select a conversation or start a new chat from the sidebar</p>
        </div>
      </div>
    );
  }
  ...
  const optimizedAvatar = otherParticipant?.avatar?.includes('cloudinary')
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gray-50 dark:bg-gray-900">
      ...
      {/* Messages area – lazy load the list */}
      ...
      <div className="sticky bottom-0 w-full bg-gray-50 dark:bg-gray-900">
        <MessageInput
          ...
          onSendMessage={(newMessage) => setMessages(prev => [...prev, newMessage])}
        />
      </div>
